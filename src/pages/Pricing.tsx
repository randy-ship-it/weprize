    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 text-sm mt-1.5 leading-relaxed">
          Browse free. Paid Once / Triple / year-round check out on Stripe (CAD). You bring your own identity. We apply; you tap codes when asked.
        </p>
      </div>
      <PricingCards autoOkLive={autoOkCount} />
      <RangesCallout autoOkLive={autoOkCount} />
